"""
Fix the _load_h5_file method - simpler approach
"""

def create_fixed_loader_v2():
    """Fix the _load_h5_file method - use paths directly."""
    
    # Read the current file
    with open('src/vantascope/data/dft_graphene_loader.py', 'r') as f:
        content = f.read()
    
    # Find and replace the _load_h5_file method
    ...
    new_method = '''    def _load_h5_file(self, file_path: str) -> Optional[Dict[str, np.ndarray]]:
        ...
        try:
            ...
            if str(self.data_path).endswith('.tar.gz'):
                ...
                # Extracted directory method - file_path is already full path
                from pathlib import Path
    ...
    print("✅ _load_h5_file method fixed (v2)!")

if __name__ == "__main__":
    create_fixed_loader_v2()
