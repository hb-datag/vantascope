...
def test_full_pipeline():
    logger.info("🚀 Testing full pipeline with Gaussian splatting...")
    
    # Create dataset pointing to extracted files
    ...
    logger.info(f"📊 Full pipeline: {samples_per_sec:.1f} samples/sec")
